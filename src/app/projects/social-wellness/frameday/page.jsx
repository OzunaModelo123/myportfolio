    ...
    <div>
      <section ref={heroRef} className="relative pt-28 md:pt-40 pb-16 md:pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          <Link href="/projects/social-wellness" className="p-anim inline-flex items-center gap-2 font-inter text-sm text-white/70 hover:text-[#8B7EC8] transition-colors mb-10 group">
