...
const INDEX_PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Social products built around intentional engagement. FrameDay is the first one: daily photo prompts and lightweight sharing without the endless feed.',
...
export default function WorkIndex() {
  ...
  return (
    <div>
      <SEO title="Projects | Daniel Ozoani" description="Projects and product builds by Daniel Ozoani. Some shipped, some in progress." />
      <section ref={heroRef} className="relative pt-28 md:pt-40 pb-16 md:pb-24 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          ...
          <h1 className="w-anim font-display font-black text-[clamp(4rem,12vw,8rem)] text-white leading-[0.88] tracking-tight mb-5">
            Projects <br /><span className="text-white drop-shadow-lg">and what I'm building.</span>
          </h1>
          <p className="w-anim font-inter text-base md:text-xl text-white/90 max-w-prose leading-relaxed">
            Here’s what I’ve been building. Some are shipped, some are in progress. Take a look.
          </p>
        </div>
      </section>
