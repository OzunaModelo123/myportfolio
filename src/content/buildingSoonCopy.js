...
export const buildingSoonVariants = {
  ...
  education: {
    ...
    confirmLabel: 'Say less, closing this tab',
  },
};
...
export const apiRapidComingSoonCopy = {
  ...
  accentColor: '#5B8C6F',
  description:
    'Almost done babysitting these endpoints. Couple polish passes on docs and auth and they\'re yours. Drops soon. PROMISE.',
